...
./mvnw -B -s .settings.xml -pl :sprinkler-simulation-app,:sprinkler-event-source,:sprinkler-decision-processor,:sprinkler-data-sink,:sprinkler-report spring-boot:build-image $MT
